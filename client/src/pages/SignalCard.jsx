...
import { 
  FaRegComment, FaRetweet, FaRegHeart, FaHeart, FaShare, FaEllipsisH, FaPlay 
} from 'react-icons/fa';
...
const SignalCard = ({ post, currentUserAuth0Id }) => {
  ...
  const handleEnergyToggle = async (e) => {
    e.stopPropagation();
    try {
      // আপনার ব্যাকএন্ড URL অনুযায়ী API কল
  ...
  return (
    ...
    >
      {/* 👤 Author Avatar */}
      <img 
        src={post.authorAvatar || post.authorPicture || "https://api.dicebear.com/7.x/bottts/svg?seed=Drifter"} 
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center justify-between group">
          <div className="flex items-center gap-1 overflow-hidden">
            <span className="font-bold hover:underline truncate text-white">{post.authorName}</span>
        ...
        {/* 🖼️ MEDIA SECTION (Image/Video Support) */}
